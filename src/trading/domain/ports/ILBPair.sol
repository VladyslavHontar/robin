...
import {ILBPairErrors} from "../kernel/ILBPairErrors.sol";
import {ILBPairEvents} from "../kernel/ILBPairEvents.sol";
...
interface ILBPair is ILBPairTypes, ILBPairErrors, ILBPairEvents {
    ...
    /**
     * @notice Set oracle module address (only factory)
     * @param _oracle Oracle module address (address(0) to disable)
     */
    function setOracle(address _oracle) external;

    /**
     * @notice Pause or unpause the pair (only factory)
